...
std::vector<Double_t> Reco2D::windowed_means(int window_size,
					     Double_t p_above, 
					     Double_t p_below,
...
Double_t Reco2D::tag_michel(ClusterYPlane& c, 
			    size_t idx,        
			    bool forward,      
			    const larlite::event_hit *evt_hits,
			    Double_t _min_rad)
...
std::vector<int> Reco2D::find_max_pos(const std::vector<Double_t>& data, 
				      float rise_edge, 
				      float fall_edge, 
				      float threshold,
				      float ped_mean, 
...
std::vector<int> Reco2D::find_min_pos(const std::vector<Double_t>& data, 
				      float rise_edge, 
				      float fall_edge, 
				      float threshold,
				      float ped_mean, 
...
int Reco2D::find_max_peak(const std::vector<Double_t>& data, 
			  int istart, 
			  int iend)
{
...
std::vector<int> Reco2D::Reconstruct_Mins( const std::vector<Double_t>& data, 
					   float rise_edge, 
					   float fall_edge, 
					   float threshold, 
					   float ped_mean, 
